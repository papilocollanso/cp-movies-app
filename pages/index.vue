...
export default{
 ...
 data (){
    ...
    methods:{
      async getMovies() {
        const data =  axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=f1669cfbca859e400709c0b192ab0655&language=en-US&page=1');
       ...
       // console.log(result.data);
           async searchMovies(){
             const data =   axios.get(`https://api.themoviedb.org/3/search/movie?api_key=f1669cfbca859e400709c0b192ab0655&language=en-US&page=1&query=${this.searchInput}`);
             const result = await data
             result.data.results.forEach((movie) =>{
